...
const Footer = () => {
  ...
  <div>
    ...
    <Link className="link link-hover">Breakfast Recipes</Link> 
      <Link className="link link-hover">Lunch Recipes</Link>  
      <Link className="link link-hover">Dinner Recipes</Link>  
      <Link className="link link-hover">Appetizer & Snack</Link> 
  </div> 
  <div>
    <span className="footer-title">Learn More</span> 
      <Link className="link link-hover">About us</Link>  
      <Link className="link link-hover">Contact</Link>  
      <Link className="link link-hover">Advertise</Link>  
      <Link className="link link-hover">Content Licensing</Link> 
  </div> 
  <div>
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  ...
  <img style={{width:'70px'}} src={logo1} alt="" />
    <p>COOKING LIGHT Restaurant <br/>Providing reliable tech since 1992</p>
  </div> 
